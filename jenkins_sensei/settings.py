"""
Django settings for jenkins_sensei project.
...
SECRET_KEY = 'e8c)1k0)kzjo-txoi1%o!%-^jm5s-22cf$1l+newlx7k%kc7h9'
...
ROOT_URLCONF = 'jenkins_sensei.urls'
...
WSGI_APPLICATION = 'jenkins_sensei.wsgi.application'
